...
\section*{Experience}
\textbf{Software Engineer}, {CORDAX} -- Toronto, ON \hfill Sep 2025 -- Dec 2025 \\
\vspace{-5pt}
\begin{itemize}
  \item Built responsive pages with Next.js, React, and TailwindCSS, cutting load times by 35\% and doubling demo sign-ups
  \item Developed a Python backend API designed for external licensing with secure authentication to support partners
  \item Refactored Python backend into a modular architecture, cutting technical debt and reducing production errors by 15\%
\end{itemize}
